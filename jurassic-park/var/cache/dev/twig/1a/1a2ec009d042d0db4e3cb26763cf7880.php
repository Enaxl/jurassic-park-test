...
class __TwigTemplate_e01b947f2a1843a984eb5b96fa1ce946 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"px-3 pb-3 pt-2 relative flex flex-col justify-between h-[100%]\">
            ...
            yield "
                    ...
                    <span onClick=\"cloneData(";
            // line 33
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dinosaure"], "id", [], "any", false, false, false, 33), "html", null, true);
            yield ")\" id=\"duplicate\" class=\"rounded bg-slate-900 p-1 inline-block hover:cursor-pointer flex items-center justify-center\">
                        ";
            // line 34
            yield Twig\Extension\CoreExtension::include($this->env, $context, "svg/duplicate-svg.html.twig");
            yield "
                    </span>
                </div>
            </div>
...
";
    ...
    {
        return array (  132 => 34,  128 => 33,  123 => 31,  119 => 30,  115 => 29,  108 => 25,  99 => 19,  95 => 18,  90 => 16,  83 => 12,  79 => 11,  70 => 5,  65 => 2,  48 => 1,);
    }
        ...
        <div class=\"px-3 pb-3 pt-2 relative flex flex-col justify-between h-[100%]\">
            ...
            <div class=\"flex flex-row justify-between items-end\">
                ...
                <div class=\"flex justify-end gap-2 mt-2\">
                    ...
                    <span onClick=\"cloneData({{dinosaure.id}})\" id=\"duplicate\" class=\"rounded bg-slate-900 p-1 inline-block hover:cursor-pointer flex items-center justify-center\">
                        {{ include('svg/duplicate-svg.html.twig') }}
                    </span>
                </div>
            </div>
        </div>
    </div>
{% endfor %}", "dinosaure/_dinosaure_cards.html.twig", "/var/www/html/templates/dinosaure/_dinosaure_cards.html.twig");
    }
}
