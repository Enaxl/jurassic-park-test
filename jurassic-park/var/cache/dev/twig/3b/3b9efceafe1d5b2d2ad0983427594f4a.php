...
class __TwigTemplate_fbf47c409354a95622359bd74a4f5d53 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"w-[70%] mx-auto p-2\">
            ...
            <div class=\"grid-cols-4 grid-rows-4 grid gap-7 overflow-hidden\" id=\"dinosaureContainer\">
                ";
        // line 60
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["dinosaures"]) || array_key_exists("dinosaures", $context) ? $context["dinosaures"] : (function () { throw new RuntimeError('Variable "dinosaures" does not exist.', 60, $this->source); })()))) {
            // line 61
            yield "                    ";
            yield from $this->loadTemplate("dinosaure/_dinosaure_cards.html.twig", "dinosaure/index.html.twig", 61)->unwrap()->yield($context);
            // line 62
            yield "                ";
        } else {
            // line 63
...
";
        // line 69
        yield from $this->loadTemplate("reuse/display/addDisplay.html.twig", "dinosaure/index.html.twig", 69)->unwrap()->yield($context);
        // line 70
        yield from $this->loadTemplate("reuse/display/updateDisplay.html.twig", "dinosaure/index.html.twig", 70)->unwrap()->yield($context);
        // line 71
        yield from $this->loadTemplate("reuse/display/cloneDisplay.html.twig", "dinosaure/index.html.twig", 71)->unwrap()->yield($context);
        // line 72
        yield "
<script>
    function filterName() {
    ...
    fetch(\"";
        // line 97
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_dinosaure_json");
        yield "\")
    ...
    function telechargerXml() {
        fetch(\"";
        // line 112
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_dinosaure_xml");
        yield "\")
            .then(response => response.blob())
            .then(blob => {
                const url = window.URL.createObjectURL(blob);
...
";
    ...
    {
        return array (  233 => 112,  215 => 97,  194 => 79,  185 => 72,  183 => 71,  181 => 70,  179 => 69,  173 => 65,  169 => 63,  166 => 62,  163 => 61,  161 => 60,  109 => 10,  107 => 9,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "dinosaure/index.html.twig", "/var/www/html/templates/dinosaure/index.html.twig");
    }
}
